...
type Querier interface {
	...
	GetLatestUserTestAttempt(ctx context.Context, arg *GetLatestUserTestAttemptParams) (int32, error)
	...
	SubmitTestResult(ctx context.Context, arg *SubmitTestResultParams) (int32, error)
